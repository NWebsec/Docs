...
NWebsec.AspNetCore.Mvc lets you configure NWebsec through MVC ActionFilter attributes. ASP.NET Core MVC is supported. By decorating controllers and actions with attributes, the [NWebsec.AspNetCore.Middleware](NWebsec.AspNetCore.Middleware.html) configuration can be overridden. Here's the order in which the final configuration is calculated:
