...
[NWebsec](NWebsec.html) lets you enable redirect validation in its simplest form with a single line of config:
...
[NWebsec.Owin](NWebsec.Owin.html) lets you do the same with a single line in your OWIN startup class:
...
For [NWebsec.Owin](NWebsec.Owin.html) your startup class would look like:
