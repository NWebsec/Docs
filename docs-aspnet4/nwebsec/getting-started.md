...
Alternatively, you can get the latest version of the assemblies under [releases](https://github.com/NWebsec/NWebsec/releases) if you want to add them by hand. In that case, refer to [Configuration](Configuration.html) to also edit the configuration by hand.
...
- [Using Content Security Policy to Prevent Cross-Site Scripting (XSS)](http://blog.sendsafely.com/post/42277333593/using-content-security-policy-to-prevent-cross-site)
- [Retrofitting Code for Content Security Policy](http://blog.sendsafely.com/post/50303516209/retrofitting-code-for-content-security-policy)

See [Content-Security-Policy](Configuring-csp.html) to learn how to enable CSP, this is where the real job starts. Good luck! :)

Note also that security headers can be enabled through MVC attributes, refer to [NWebsec.Mvc](NWebsec.Mvc.html) for details.
