...
NWebsec.SessionSecurity is a separate library that improves ASP.NET session security. Read more about the improvements in the blog post [Ramping up ASP.NET session security](http://www.dotnetnoob.com/2013/07/ramping-up-aspnet-session-security.html).
