...
Removed the two AES-GCM cipher suites from TLS configuration to avoid potential issues introduced by [MS14-066](https://support.microsoft.com/kb/2992611).
